...
*** Test Cases ***
CT 07.01 - Validar menu Configurações > Requisições
...
CT 07.02 - Validar menu Configurações > Documentos
...
CT 07.03 - Validar menu Configurações > Estimativa
...
CT 07.04 - Validar menu Configurações > Sistema
